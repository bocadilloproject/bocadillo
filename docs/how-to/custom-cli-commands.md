...
Bocadillo provides a handy [CLI](../topics/cli.md) for performing common tasks. If you find yourself repeating certain tasks, you can automate them via a custom `boca` command.
